...
// netlify/functions/repositories/nasa-apod-repository.cjs
var require_nasa_apod_repository = __commonJS({
  "netlify/functions/repositories/nasa-apod-repository.cjs"(exports2, module2) {
    var fetch2 = (...args) => Promise.resolve().then(() => (init_src(), src_exports)).then(({ default: fetch3 }) => fetch3(...args));
    var NasaApodRepository2 = class {
    ...
    module2.exports = NasaApodRepository2;
  }
});

// netlify/functions/nasa_apod.cjs
var NasaApodRepository = require_nasa_apod_repository();
...
*/
//# sourceMappingURL=nasa_apod.js.map
